...
<body class="min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-lg mx-auto bg-dark-gradient rounded-lg shadow-dark-lg p-8">
        ...
        <!-- Header -->
        <header class="mb-8">
            <h1 class="text-3xl font-extrabold text-light text-center">Edit Record</h1>
        </header>
        ...
        <form action="/{{ $student->id }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" value="{{ $student->name }}" class="mt-1 block w-full rounded-md input-dark p-3">
            </div>

            <!-- Email Field -->
            <div class="mb-6">
                <label for="email" class="block text-sm font-medium text-light">Email</label>
                <input type="email" id="email" name="email" value="{{ $student->email }}" class="mt-1 block w-full rounded-md input-dark p-3">
            </div>

            <!-- Age Field -->
            <div class="mb-6">
                <label for="age" class="block text-sm font-medium text-light">Age</label>
                <input type="number" id="age" name="age" value="{{ $student->age }}" min="0" max="120" class="mt-1 block w-full rounded-md input-dark p-3">
            </div>
